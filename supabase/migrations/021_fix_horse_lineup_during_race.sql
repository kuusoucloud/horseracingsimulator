-- Fix horse lineup during race - preserve all 8 horses
...
BEGIN
  ...
  ELSIF current_race.race_state = 'racing' THEN
    ...
    -- Simple race completion after 20 seconds with all 8 horses
    IF new_timer >= 20 THEN
      ...
      SET 
        ...
        horses = '[
          {"id": "1", "name": "Thunder Bolt", "position": 1200, "placement": 1, "finishTime": 18, "lane": 1},
          {"id": "2", "name": "Lightning Strike", "position": 1200, "placement": 2, "finishTime": 19, "lane": 2},
          {"id": "3", "name": "Storm Chaser", "position": 1200, "placement": 3, "finishTime": 20, "lane": 3},
          {"id": "4", "name": "Wind Runner", "position": 1180, "placement": 4, "finishTime": 20, "lane": 4},
          {"id": "5", "name": "Fire Dash", "position": 1160, "placement": 5, "finishTime": 20, "lane": 5},
          {"id": "6", "name": "Ice Breaker", "position": 1140, "placement": 6, "finishTime": 20, "lane": 6},
          {"id": "7", "name": "Star Gazer", "position": 1120, "placement": 7, "finishTime": 20, "lane": 7},
          {"id": "8", "name": "Moon Walker", "position": 1100, "placement": 8, "finishTime": 20, "lane": 8}
        ]'::jsonb,
        race_results = '[
          {"id": "1", "name": "Thunder Bolt", "placement": 1, "finishTime": 18},
          {"id": "2", "name": "Lightning Strike", "placement": 2, "finishTime": 19},
          {"id": "3", "name": "Storm Chaser", "placement": 3, "finishTime": 20}
        ]'::jsonb,
        photo_finish_results = '[
          {"id": "1", "name": "Thunder Bolt", "placement": 1, "finishTime": 18},
          {"id": "2", "name": "Lightning Strike", "placement": 2, "finishTime": 19},
